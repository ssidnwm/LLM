...
def apply_prompt_template(query):
    system_prompt_template = PromptTemplate(
        ...
        template="""All answers are based on the documentation,If you don't answer, 
        explain why You should never answer I DON'T KNOW. and The document comes from JSON. 
        Answer concisely and do not include document context\nQuestion: {question}
        """
    )
